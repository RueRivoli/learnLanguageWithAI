    ...
    <div class="h-full relative flex flex-col justify-between z-10">
      <div class="flex items-center justify-between">
        <div class="flex-1">
          <h3
            :class="{
              'text-md text-gray-900 font-semibold': props.lightMode,
              'text-lg text-gray-800 font-semibold': !props.lightMode,
            }"
          >
            {{ props.titleEn }}
          </h3>
        ...
        <div class="flex-shrink-0 ml-3">
          <div class="relative">
            ...
            >
              <span
                class="h-4 w-4 text-white font-semibold flex items-center justify-center"
                >{{ props.symbol }}</span
              >
            </div>
          </div>
