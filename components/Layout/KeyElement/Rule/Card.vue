  ...
  <div
    :class="[
      props.backgroundClasses
        ? `group relative rounded-md shadow-md p-4 overflow-hidden ${props.backgroundClasses}`
        : 'group relative bg-gradient-to-br from-green-100/90 via-green-50/95 to-emerald-100/80 rounded-xl shadow-md border border-green-300/70 p-4 hover:border-green-400/80 overflow-hidden transition-all duration-300',
    ]"
  >
    <div class="wrapper-header">
      <div class="wrapper-title">
        ...
        <div>
          <h3 class="text-2xl font-light text-gray-900 mb-1">
            {{ props.title }}
          </h3>
