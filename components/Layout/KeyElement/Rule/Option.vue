      ...
      <div class="flex items-center justify-between mb-3">
        <div class="flex items-center gap-2">
          ...
          <div class="flex flex-col">
            <h3
              :class="{
                'text-xl text-gray-900 mb-0.5': props.lightMode,
                'text-xl text-gray-800 mb-0.5': !props.lightMode,
              }"
            >
              {{ props.titleEn }}
            </h3>
            <p
              :class="{
                'text-sm text-gray-900 font-light': props.lightMode,
                'text-sm text-gray-800 font-light': !props.lightMode,
              }"
            >
              {{ props.title }}
            </p>
