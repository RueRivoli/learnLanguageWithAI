...
<template>
  <div class="w-full">
    <div
      class="bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 rounded-lg shadow-lg border border-gray-300 p-6"
    >
      <!-- Loading State -->
      ...
      <div v-else class="space-y-5">
        ...
        <div class="border-b border-gray-100 pb-4">
          <div class="flex items-center justify-between gap-3">
            <div class="flex items-center gap-2">
              <div
                class="p-2 bg-gradient-to-br from-primary/10 to-primary/20 rounded-lg"
              >
        ...
        <div class="space-y-3">
          <div v-if="!props.quizs.length" class="text-center py-8">
            <div
              class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-full flex items-center justify-center"
            >
          ...
          <div class="pt-4 border-t border-gray-100">
            <button
              class="w-full bg-primary text-primary-content cursor-pointer hover:bg-primary/90 font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 disabled:opacity-50"
              :disabled="isLoading"
              @click="handleGenerateQuiz"
            >
              <span
                v-if="isLoading"
                class="animate-spin cursor-pointer rounded-full h-4 w-4 border-2 border-white border-t-transparent"
              />
