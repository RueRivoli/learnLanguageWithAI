  ...
  >
    <div class="mx-auto max-w-[90rem] px-6 lg:px-8">
      ...
      <div class="text-center mb-20">
        ...
        >
          Our Language Learning Platform is designed to train you on your
          weaknesses so that you improve faster and more efficiently.
        </p>
      </div>
      ...
      <div class="space-y-24">
        ...
        <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          <div class="space-y-6 order-2 lg:order-1 lg:col-span-2">
            ...
            <h3 class="text-3xl sm:text-4xl text-neutral">
              ...
              <span class="text-warning">50+</span> Most Important Key Concepts
            </h3>
            <p class="text-lg sm:text-xl text-base-content/70 leading-relaxed">
              Tookan knows your weaknesses and strengths. It tracks your
              progress and provides you with a detailed analysis of your skills.
            </p>
          ...
          <div class="order-1 lg:order-2 lg:col-span-3">
            <div class="relative group">
              <div
                class="absolute rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <img
        ...
        <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          <div class="space-y-6 lg:col-span-2">
            ...
            <p class="text-lg sm:text-xl text-base-content/70 leading-relaxed">
              With the help of a frequency dictionnary, Tookan follows your
              vocabulary knowledge and train you on your unfamiliar vocabulary.
            </p>
            <div class="flex items-center gap-2 text-primary font-semibold">
          ...
          <div class="flex flex-col items-center lg:col-span-3">
            <div class="relative group">
              <div
                class="absolute rounded-lg blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <img
                src="/wordsHM.png"
        ...
        <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          <div class="space-y-6 order-2 lg:order-1 lg:col-span-2">
            ...
            <p class="text-lg sm:text-xl text-base-content/70 leading-relaxed">
              Generate stories using your weak concepts and your unfamiliar
              vocabulary.
            </p>
            <div class="flex items-center gap-2 text-primary font-semibold">
          ...
          <div class="flex flex-col items-center lg:col-span-3">
            <div class="relative group">
              <div
                class="absolute group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <img
        ...
        <div class="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          <div class="space-y-6 lg:col-span-2">
            ...
            <p class="text-lg sm:text-xl text-base-content/70 leading-relaxed">
              After each lesson, evaluate your progress with a quiz prepared by
          ...
          <div class="lg:col-span-3">
            <div class="relative group">
              <div
                class="absolute -inset-4 bg-gradient-to-r from-warning/20 to-primary/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ></div>
              <img
      ...
      <div class="text-center mt-20">
        <div
          class="inline-flex items-center gap-3 rounded-lg bg-primary/10 px-6 py-3 hover:bg-primary/20"
        >
          <NuxtLink
            :to="{
          ...
          >
            <span class="text-primary font-semibold"
              >Ready to Start Learning Faster ?</span
            >
