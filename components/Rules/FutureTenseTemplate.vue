<template>
  <div class="max-w-4xl mx-auto p-6 space-y-6">
          ...
          <ul class="space-y-1 text-sm text-gray-700">
            ...
            <li class="flex items-start gap-2">
              ...
              <span>
                ...
                <em> (he/she ll call you in the evening)</em>
              </span>
            </li>
            <li class="flex items-start gap-2">
              <span
    ...
    <div>
      ...
      <p class="mt-2 mb-3 font-semibold">Irregular Verbs</p>
      <div class="space-y-4">
        <!-- Proper Names -->
        ...
        <li class="flex items-start gap-2">
          ...
          <span>
            ...
            <code class="bg-white px-2 py-1 rounded border text-sm"
              >-ma/-me</code
            >
            according to the <strong>e-vowel harmony</strong>
          </span>
        </li>
        <li class="flex items-start gap-2">
          <span
        ...
        <div class="border-l-4 border-success pl-4">
          <ul class="space-y-1 text-sm text-gray-700">
            <li class="flex items-start gap-2">
              ...
              <span>
                <span class=""
                  >Gitmek <em>(to go)</em> -> yarın okula git<strong
                    class="text-success"
                    >meyeceğim</strong
                  >
                </span>
            ...
            <li class="flex items-start gap-2">
              ...
              <span>
                <span class=""
                  >Kabul etmek <em>(to accept)</em> -> o bunu kabul et<strong
                    class="text-success"
                    >meyecek</strong
                  >
                </span>
            ...
            <li class="flex items-start gap-2">
              ...
              <span>
                <span class=""
                  >Söylemek <em>(to say)</em> -> ben böyle bir şey söyle<strong
                    class="text-success"
                    >meyeceğim</strong
                  >
                </span>
        ...
        <div class="border-l-4 border-success pl-4">
          <ul class="space-y-1 text-sm text-gray-700">
            ...
            <li class="flex items-start gap-2">
              ...
              <span>
                <span class=""
                  >Yardım etmek <em>(to help)</em> -> bize yardım<strong
                    class="text-success"
