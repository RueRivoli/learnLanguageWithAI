...
export const promptGeneratedWordQuiz = (wordsForQuiz: any) => {
    ...
    If possible, make that the incorrect answer are almost similar to the correct answer but not the same: for example change just one letter or something else. 
