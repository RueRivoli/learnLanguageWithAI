...
const expressionsOverall  = supabase.from("turkish_expressions").select("id, text, translation, turkish_expressions_knowledge!left(expression_mastered)", { count: "exact"}).order("id", { ascending: true }).range(from, to) 
