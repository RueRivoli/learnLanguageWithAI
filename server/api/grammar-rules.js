...
var supabase = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL, process.env.SERVICE_SUPABASE_KEY);
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var query, difficulty, request, _a, data, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                query = getQuery(event);
                difficulty = query.difficulty_class;
                request = supabase
