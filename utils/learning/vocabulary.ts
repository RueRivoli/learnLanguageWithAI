...
export type DatabaseWords =
  Database["public"]["Tables"]["turkish_words"]["Row"];
export type DatabaseExpressions =
  Database["public"]["Tables"]["turkish_expressions"]["Row"];
...
type ExpressionListFetched = Array<
  Database["public"]["Tables"]["turkish_expressions"]["Row"]
>;

export const parseExpressions = (
  expressions: ExpressionListFetched,
): Array<Expression> => {
