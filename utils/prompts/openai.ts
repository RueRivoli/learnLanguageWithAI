const openAiPrompt = (level: string, words: string, expressions: string, grammarRule: string, nbLines: number) =>  {
    const prompt = `
        ...
        and employing some usages of the following rule: ${grammarRule}.
        Don't use this rule too often but use it at least 3 or 4 times.
        ...
        The intro should not be longer than 3 or 4 sentences and shouldn't be too marketing or salesy: avoid sentences like "in this amazing story, in this captivating story", give a realistic introduction"
